...
const styles = StyleSheet.create({
  ...
  subtitle: {
    fontSize: 14, color: '#666', textAlign: 'center', lineHeight: 22, marginBottom: 28,
  },
  ...
  gmapsBtn: {
    ...
    marginBottom: 12, width: '100%', maxWidth: 420, justifyContent: 'center',
  },
  gmapsBtnText: { color: '#fff', fontWeight: '700', fontSize: 15 },
  refreshBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: '#6C63FF22', borderRadius: 14,
    paddingHorizontal: 24, paddingVertical: 13,
    borderWidth: 1, borderColor: '#6C63FF44',
    width: '100%', maxWidth: 420, justifyContent: 'center',
  },
